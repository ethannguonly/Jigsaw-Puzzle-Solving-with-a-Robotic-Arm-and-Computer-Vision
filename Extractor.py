...
def show_contours(contours, imgRef):
    ...
    show_image(whiteImg)
    cv2.imwrite("./images/output/contours.png", whiteImg)
...
class Extractor():
    ...
    def __init__(self, path, viewer=None, green_screen=False, factor=0.84):
        ...
        if green_screen: #changed
            ...
            cv2.imwrite("./images/output/resized.png", self.img)
            remove_background("./images/output/resized.png", factor=factor)
            self.img_bw = cv2.imread("./images/output/green_background_removed.png", cv2.IMREAD_GRAYSCALE)
    ...
    def extract(self):
        ...
        cv2.imwrite("./images/output/binarized.png", self.img_bw)
        if self.viewer is not None:
            self.viewer.addImage("Binarized", "./images/output/binarized.png")
        ...
        def generated_preprocesing():
            ...
            cv2.imwrite("./images/output/otsu_binarized.png", self.img_bw)
        ...
        cv2.imwrite("./images/output/binarized_treshold_filled.png", self.img_bw)
        if self.viewer is not None:
            self.viewer.addImage("Binarized treshold", "./images/output/binarized_treshold_filled.png")
        ...
        puzzle_pieces = export_contours(self.img, self.img_bw, contours, "./images/output/contours.png", 5, viewer=self.viewer, green=self.green_)
