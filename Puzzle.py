from Distance import diff_match_edges, real_edge_compute, generated_edge_compute
...
from tuple_helper import equals_tuple, add_tuple, sub_tuple, is_neigbhor, corner_puzzle_alignement, display_dim
...
class Puzzle():
    ...
    def __init__(self, path, viewer=None, green_screen=False):
        ...
        self.export_pieces("/tmp/stick.png", "./images/output/solved.png", display=True)
...
trial = Puzzle("./images/samples/flipped.jpg")
#